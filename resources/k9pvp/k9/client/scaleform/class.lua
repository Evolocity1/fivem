exports("TimerBarBase", function(Type, title, text, numCheckpoints)
    local CAS = exports["k9pvp"]:GetCoordsAndSizes()

    local self = {
        _Type = Type,
        _id = exports["k9pvp"]:generateRandomString(8),
        _thin = false,
        _color = {255, 255, 255, 255},
        _inProgressColor = {255, 255, 255, 51},
        _failedColor = {0, 0, 0, 255},
        _checkpointStates = {},
        _numCheckpoints = numCheckpoints ~= nil and exports["k9pvp"]:clamp(numCheckpoints, 0, 16) or nil,
        _title = title or "",
        _highlightColor = nil,
        _text = text or "",
        titleDrawParams = {
    ...
    local Func = {
        lib = {
            TextTimerBar = {
                ...
                setTextColor = function(value)
                    self.textDrawParams.color = exports["k9pvp"]:getColorFromValue(value)
                end,
                ...
                draw = function(y)
                    ...
                    exports["k9pvp"]:drawTextLabel(self._textGxtName, {CAS.initialX, y}, self.textDrawParams)
                end,
            ...
            PlayerTimerBar = {
                draw = function(y)
                    ...
                    exports["k9pvp"]:drawTextLabel(self._titleGxtName, {CAS.initialX, y + CAS.playerTitleOffset}, titleDrawParams)
                    exports["k9pvp"]:drawTextLabel(self._textGxtName, {CAS.initialX, y + CAS.textOffset}, self.textDrawParams)
                end
            },
            CheckpointTimerBar = {
                ...
                setColor = function(value)
                    self._color = exports["k9pvp"]:getColorFromValue(value)
                end,

                setInProgressColor = function(value)
                    self._inProgressColor  = exports["k9pvp"]:getColorFromValue(value)
                end,

                setFailedColor = function(value)
                    self._failedColor  = exports["k9pvp"]:getColorFromValue(value)
                end,
        ...
        setTitleColor = function(value)
            self.titleDrawParams.color = exports["k9pvp"]:getColorFromValue(value)
        end,

        setHighlightColor = function(value)
            self._highlightColor = value and exports["k9pvp"]:getColorFromValue(value) or nil
        end,
        ...
        drawTitle = function(y)
            exports["k9pvp"]:drawTextLabel(self._titleGxtName, {CAS.initialX, y}, self.titleDrawParams)
        end,
