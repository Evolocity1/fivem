...
let buildingInProgresss = false;
let currentBuildingModules = '';
    ...
    build(resourceName, cb) {
        let buildWebpack = async () => {
            ...
            for (const configName of configs) {
                ...
                const workers = workerFarm(require.resolve('./webpack/webpack_runner'));

                if (config) {
                    const resourcePath = path.resolve(GetResourcePath(resourceName));

                    while (buildingInProgresss) {
                    ...
                    buildingInProgresss = true;
                    currentBuildingModules = resourceName;
                    ...
                    promises.push(new Promise((resolve, reject) => {
                        workers({
                            ...
                            if (err) {
                                ...
                                buildingInProgresss = false;
                                currentBuildingModules = '';
