...
function spawnPlayer(spawnIdx, cb)
    ...
    Citizen.CreateThread(function()
        ...
        --[[MP.TriggerServerCallback('esx_skin:getPlayerSkin', function(skin)
                if skin then
                    TriggerEvent('skinchanger:loadSkin', skin)
                else
                    OpenMenuSkin({coords = vector3(71.43296, -1398.818, 29.36414), category = {{name = "tshirt_1", min = nil, max = nil}, {name = "tshirt_2", min = nil, max = nil}, {name = "torso_1", min = nil, max = nil}, {name = "torso_2", min = nil, max = nil}, {name = "decals_1", min = nil, max = nil}, {name = "arms", min = nil, max = nil}, {name = "pants_1", min = nil, max = nil}, {name = "pants_2", min = nil, max = nil}, {name = "shoes_1", min = nil, max = nil}, {name = "shoes_2", min = nil, max = nil}, {name = "bags_1", min = nil, max = nil}, {name = "bags_2", min = 0, max = 10}}})
                end
        end)]]
        print(spawn.anim)
        if spawn.anim then
