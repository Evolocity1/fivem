...
function MySQL.Sync.execute(query, params)
    ...
    exports['k9pvp']:mysql_execute(query, safeParameters(params), function (result)
        res = result
        finishedQuery = true
    end)
...
function MySQL.Sync.fetchAll(query, params)
    ...
    local res = {}
    local finishedQuery = false
    exports['k9pvp']:mysql_fetch_all(query, safeParameters(params), function (result)
        res = result
        finishedQuery = true
    end)
    repeat Citizen.Wait(0) until finishedQuery == true
...
function MySQL.Sync.fetchScalar(query, params)
    ...
    local res = ''
    local finishedQuery = false
    exports['k9pvp']:mysql_fetch_scalar(query, safeParameters(params), function (result)
        res = result
        finishedQuery = true
    end)
    repeat Citizen.Wait(0) until finishedQuery == true
...
function MySQL.Sync.insert(query, params)
    ...
    local res = 0
    local finishedQuery = false
    exports['k9pvp']:mysql_insert(query, safeParameters(params), function (result)
        res = result
        finishedQuery = true
    end)
    repeat Citizen.Wait(0) until finishedQuery == true
...
function MySQL.Sync.store(query)
    ...
    local res = -1
    local finishedQuery = false
    exports['k9pvp']:mysql_store(query, function (result)
        res = result
        finishedQuery = true
    end)
    repeat Citizen.Wait(0) until finishedQuery == true
...
function MySQL.Sync.transaction(querys, params)
    local res = 0
    local finishedQuery = false
    exports['k9pvp']:mysql_transaction(querys, params, function (result)
        res = result
        finishedQuery = true
    end)
    repeat Citizen.Wait(0) until finishedQuery == true
...
function MySQL.Async.execute(query, params, func)
    ...
    exports['k9pvp']:mysql_execute(query, safeParameters(params), func)
end
...
function MySQL.Async.fetchAll(query, params, func)
    ...
    exports['k9pvp']:mysql_fetch_all(query, safeParameters(params), func)
end
...
function MySQL.Async.fetchScalar(query, params, func)
    ...
    exports['k9pvp']:mysql_fetch_scalar(query, safeParameters(params), func)
end
...
function MySQL.Async.insert(query, params, func)
    ...
    exports['k9pvp']:mysql_insert(query, safeParameters(params), func)
end
...
function MySQL.Async.store(query, func)
    ...
    exports['k9pvp']:mysql_store(query, func)
end
...
function MySQL.Async.transaction(querys, params, func)
    return exports['k9pvp']:mysql_transaction(querys, params, func)
end
...
function MySQL.ready (callback)
    Citizen.CreateThread(function ()
        ...
        while not exports['k9pvp']:is_ready() do
            Citizen.Wait(0)
        end
        callback()
    end)
