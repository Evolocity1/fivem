...
function GetLevel()
    local aaa = XNL_GetLevelFromXP(XNL_CurrentPlayerXP) == 1 and 0 or XNL_GetXPCeilingForLevel(XNL_GetLevelFromXP(XNL_CurrentPlayerXP) - 1)
    local calc = ((XNL_CurrentPlayerXP - aaa) / (XNL_GetXPCeilingForLevel(XNL_GetLevelFromXP(XNL_CurrentPlayerXP)) - aaa)) * 100

    return XNL_GetLevelFromXP(XNL_CurrentPlayerXP), XNL_GetXPCeilingForLevel(CurLevel), calc
end
